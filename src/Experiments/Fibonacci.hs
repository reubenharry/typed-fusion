...
--
-- Trees \/ Fuse \/ Mult come from 'Experiments.Fusion.Obj'; Hom from
-- 'Experiments.Fusion.Hom'; tensor\/braid\/associator from 'Experiments.Fusion.Ops'.
